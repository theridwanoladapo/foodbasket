				...
				<div class="navigation d-flex">
					...
					<ul class="navbar-nav nav-left">
						...
						<li class="nav-item dropdown">
							<a href="javascript:void(0)" class="nav-link " id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Drop Down <i class="fa fa-angle-down"></i></a>
								...
								<div class="bg-gradient px-4 py-3">
									<div class="d-flex align-items-center justify-content-between">
										<div class="mr-1">
											...
											<small class="text-white">alicewilliams@foodbasket.com</small>
										</div>
