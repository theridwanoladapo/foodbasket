					...
					<div class="col-sm-6 col-lg-5 col-xxl-3 align-self-center order-2 order-sm-1">
						<div class="d-flex align-items-center app-wrap">
							<div class="register p-5">
								...
								<form method="post" action="<?php echo base_url().'index.php?register/signup/agent';?>" id="agentsignup" class="mt-5 mt-sm-5">
									<div class="row">
								...
								<div class="row pt-3">
									...
									<div class="col-md-6"><a href="<?php echo base_url().'?register/merchant';?>" class="btn btn-outline-primary btn-block">Sign up as a merchant</a></div>
								</div>
							</div>
						</div>
					</div>
