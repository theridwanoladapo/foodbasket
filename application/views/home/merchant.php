					...
					<div class="col-sm-6 col-lg-5 col-xxl-3 align-self-center order-2 order-sm-1">
						<div class="d-flex align-items-center app-wrap">
							<div class="register p-5">
								...
								<form method="post" action="<?php echo base_url().'index.php?register/signup/merchant';?>" id="merchantsignup" class="mt-5 mt-sm-5">
									<div class="row">
										...
										<div class="col-12">
											<div class="form-group">
												...
												<input type="text" name="store_name" class="form-control" placeholder="Provide your store name" tabindex="5" autocomplete="off" required>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group">
												<label class="control-label">Store Location</label>
												<input type="text" name="store_location" class="form-control" placeholder="Provide your store location" tabindex="6" autocomplete="off" required>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="text" name="username" class="form-control" placeholder="Choose a username" tabindex="7" autocomplete="off" required>
												</div>
											</div>
										</div>
										<div class="col-12">
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="password" name="upin" inputmode="numeric" pattern="[0-9]{6}" class="form-control" placeholder="Set your 6 digits pin" maxlength="6" tabindex="8" onKeyPress="return onlyNumberKey(event)" autocomplete="off" required>
												</div>
											</div>
										</div>
								...
								<div class="row pt-3">
									<div class="col-md-6"><a href="<?php echo base_url().'?register/member';?>" class="btn btn-outline-primary btn-block mb-3 mb-md-0">Sign up as a member</a></div>
	...
	<script> 
		...
		$(document).ready(function() {
			$("#merchantsignup").submit(function(e) {
				e.preventDefault();
