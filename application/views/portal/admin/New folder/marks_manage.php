...
?>
					...
					<div class="row">
						<div class="col-12">
							...
							<div class="card card-primary card-outline">
								<!-- form start -->
								<form class="" method="post" action="<?php echo base_url();?>index.php?admin/marks_selector">
									<div class="card-body">
										<div class="form-group row">
											...
											<div class="col-md-3">
												...
												onchange="return mark_class_section(this.value)" required>
											...
											<div class="col-md-3">
												...
												onchange="mark_class_section_subject(this.value)"
												id="section_selector_holder" required>
													<option value="">Select Class First</option>
												</select>
											</div>
											<div class="col-md-3">
												<label for="inputClass" class="control-label"> Subject </label>
						...
						<!-- / .col -->
						<div class="col-12">
							<div id="student_promotion_selector">
							</div>
						</div>
						<!-- / .col -->
					</div>
		...
		<script type="text/javascript">			
			...
			{
				$.ajax({
					url: '<?php echo base_url();?>index.php?admin/mark_class_section/' + class_id ,
				...
				$(document).ready(function() {
					...
					mark_class_section_subject(class_id, section_id);
				}); 
			}
			
			function mark_class_section_subject(section_id)
			{
				var class_id = $('#class_id').val();
				
				$.ajax({
					url: '<?php echo base_url();?>index.php?admin/mark_class_section_subject/' + class_id + '/' + section_id,
					success: function(response)
					{
