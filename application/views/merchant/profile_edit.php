	...
	<div class="container-fluid">
		...
		<div class="row">
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="nav nav-pills flex-column">
							<li class="nav-item">
								<a href="<?php echo base_url().'?merchant/edit/profile';?>" class="nav-link active">Edit Profile</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo base_url().'?merchant/edit/store';?>" class="nav-link">Store Info</a>
							</li>
							<li class="nav-item">
			...
			<div class="col-md-8">
				...
				?>
				<form method="post" action="<?php echo base_url().'index.php?merchant/manage/profile/'.$user_id;?>" id="editform">
