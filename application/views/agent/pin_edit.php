	...
	<div class="container-fluid">
		...
		<div class="row">
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="nav nav-pills flex-column">
							<li class="nav-item">
								<a href="<?php echo base_url().'?agent/edit/profile';?>" class="nav-link">Edit Profile</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo base_url().'?agent/edit/pin';?>" class="nav-link active">Security</a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="col-md-8">
				...
				?>
				<form method="post" action="<?php echo base_url().'index.php?agent/manage/pin/'.$user_id;?>" id="editform">
