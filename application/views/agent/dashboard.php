<div class="app-main" id="main">
	...
	<div class="container-fluid">
			...
			<div class="col-md-12 m-b-30">
				...
				<div class="d-block d-lg-flex flex-nowrap align-items-center">
					...
					<div class="ml-auto d-flex align-items-center secondary-menu text-center">
						<a href="<?php echo base_url() . '?agent/transfer';?>" class="btn btn-primary btn-block">
		...
		<div class="row">
			<?php
				$user_id = $this->session->userdata('agent_login_id');
				$agent = $this->db->get_where('user', array('user_id' => $user_id))->row();
			?>
			<div class="col-md-12">
				<div class="card">
						...
						<div class="row counter-wrapper">
							<div class="col-sm-6 mb-3">
								<div class="border-primary rounded text-center p-3">
									<h3><?php echo ucwords($agent->firstname.' '.$agent->lastname);?></h3>
									<h4><span class="text-primary">Email:</span> <?php echo $agent->email;?></h4>
									<h4><span class="text-primary">Account No.:</span> <?php echo $agent->account_no;?></h4>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-5">
								...
								<div class="input-group mb-3">
									<input type="text" id="txt" class="form-control" value="<?php echo base_url().'?register/ref/'.$agent->referral_code;?>">
							...
							<div class="col-md-3">
								...
								<span class="btn btn-outline-primary btn-block btn-lg text-center mb-3">
									<?php echo 'Level #' . $agent->level . ', Stage #' . $agent->stage;?>
								</span>
							</div>
							<div class="col-md-2">
								<label>Total Referrals</label>
								<span class="btn btn-outline-primary btn-block btn-lg text-center mb-3">
									<?php $referrer = $this->db->get_where('user', array('referrer' => $agent->referral_code))->num_rows(); ?>
									<?php echo $referrer;?>
								</span>
							</div>
							<div class="col-md-2">
			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div class="card-footer bg-white">
						<a href="<?php echo base_url() . '?agent/referral';?>"><i class="fa fa-angle-down"></i> &nbsp; View more referral</a>
					</div>
				</div>
			</div>
		</div>
