	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12 m-b-30">
				...
				<div class="d-block d-lg-flex flex-nowrap align-items-center">
					<div class="mr-3">
						<a href="<?php echo base_url().'?agent/profile';?>" class="btn btn-inverse-primary btn-sm btn-icon">
		...
		<div class="row">
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="nav nav-pills flex-column">
							<li class="nav-item">
								<a href="<?php echo base_url().'?agent/edit/profile';?>" class="nav-link active">Edit Profile</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo base_url().'?agent/edit/pin';?>" class="nav-link">Security</a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="col-md-8">
				...
				?>
				<form method="post" action="<?php echo base_url().'index.php?agent/manage/profile/'.$user_id;?>" id="editform">
			...
			success: function(response)
			{
				...
				if(data.type == 'success')
				{
					swal({
						...
						if (result.value) {
							window.location = "<?php echo base_url().'?agent/profile'?>"
						}
					});
				}
