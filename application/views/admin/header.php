				...
				<div class="navigation d-flex">
					...
					<ul class="navbar-nav nav-right ml-auto">
						...
						<li class="nav-item dropdown user-profile">
							...
							<img src="assets/img/logo-icon1.png" alt="Admin image">
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="mr-1">
											<?php
												...
												$admin = $this->db->get_where('admin', array('id' => $admin_id))->row();
											?>
											<h4 class="text-white mb-0"><?php echo ucwords($admin->username); ?></h4>
											<small class="text-white">admin@foodbasket.com</small>
										</div>
										<a href="<?php echo base_url();?>?admin/logout" class="text-white font-20 tooltip-wrapper" data-toggle="tooltip" data-placement="top" title="" data-original-title="Logout"> <i class="zmdi zmdi-power"></i></a>
									</div>
								</div>
								<div class="p-4">
									...
									<!-- <a class="dropdown-item d-flex nav-link" href="javascript:void(0)">
										<i class="fa fa-envelope pr-2 text-primary"></i> Activities
