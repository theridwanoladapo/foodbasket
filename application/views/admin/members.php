						...
						<div class="card-body">
							...
							<div class="tab nav-bt">
								<ul class="nav nav-tabs" role="tablist">
									<li class="nav-item">
										<a class="nav-link active show" id="all-tab" data-toggle="tab" href="#all" role="tab" aria-controls="all" aria-selected="true">All Members</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" id="new-tab" data-toggle="tab" href="#new" role="tab" aria-controls="new" aria-selected="false">Inactive Members</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" id="active-tab" data-toggle="tab" href="#active" role="tab" aria-controls="active" aria-selected="false">Active Members</a>
									</li>
								</ul>
								...
								<div class="tab-content">
											...
											<table id="members" class="table table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<button type="button" class="btn btn-primary btn-sm" onClick="showModalCenter('<?php echo base_url().'index.php?modal/popup/view_user/'.$usr->user_id;?>')">View</button>
															<?php if ($usr->status == 1):?>
									...
									<div class="tab-pane fade py-3 px-3" id="new" role="tabpanel" aria-labelledby="new-tab">
										<?php 
											$where = array('category' => 'member', 'status' => 0);
											$orderby = array('user_id', 'DESC');
											$users = $this->db->get_where('user', $where, $orderby)->result_object();
										?>
										<div class="datatable-wrapper table-responsive">
									...
									<div class="tab-pane fade py-3 px-3" id="active" role="tabpanel" aria-labelledby="active-tab">
										<?php 
											$where = array('category' => 'member', 'status' => 1);
											$orderby = array('user_id', 'DESC');
											$users = $this->db->get_where('user', $where, $orderby)->result_object();
										?>
										<div class="datatable-wrapper table-responsive">
