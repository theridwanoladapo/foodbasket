						...
						<div class="card-body">
							...
							<div class="tab nav-bt">
								<ul class="nav nav-tabs" role="tablist">
									<li class="nav-item">
										<a class="nav-link active show" id="all-tab" data-toggle="tab" href="#all" role="tab" aria-controls="all" aria-selected="true">All Agents</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" id="new-tab" data-toggle="tab" href="#new" role="tab" aria-controls="new" aria-selected="false">Inactive Agents</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" id="active-tab" data-toggle="tab" href="#active" role="tab" aria-controls="active" aria-selected="false">Active Agents</a>
									</li>
								</ul>
								...
								<div class="tab-content">
									...
									<div class="tab-pane fade py-3 px-3" id="new" role="tabpanel" aria-labelledby="new-tab">
										<?php 
											$where = array('category' => 'agent', 'status' => 0);
											$orderby = array('user_id', 'DESC');
											$users = $this->db->get_where('user', $where, $orderby)->result_object();
										?>
										<div class="datatable-wrapper table-responsive">
									...
									<div class="tab-pane fade py-3 px-3" id="active" role="tabpanel" aria-labelledby="active-tab">
										<?php 
											$where = array('category' => 'agent', 'status' => 1);
											$orderby = array('user_id', 'DESC');
											$users = $this->db->get_where('user', $where, $orderby)->result_object();
										?>
										<div class="datatable-wrapper table-responsive">
