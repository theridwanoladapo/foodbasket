				...
				<div class="navigation d-flex">
					...
					<ul class="navbar-nav nav-right ml-auto">
						...
						<li class="nav-item dropdown user-profile">
							...
							<img src="assets/img/logo-icon1.png" alt="Member image">
							...
							<div class="dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
								<div class="bg-gradient px-4 py-3">
									<div class="d-flex align-items-center justify-content-between">
										<div class="mr-1">
											...
											?>
											<h4 class="text-white mb-0"><?php echo ucwords($member->username); ?></h4>
											<small class="text-white"><?php echo $member->email; ?></small>
										</div>
								...
								<div class="p-4">
									<a class="dropdown-item d-flex nav-link" href="<?php echo base_url().'?member/profile';?>">
